...
def calcular_reflejo_punto_eje_x(lista_parametros_punto):
...
def calcular_reflejo_poligono_eje_x(lista_de_listas_de_puntos):
    lista_de_listas_de_puntos_reflejados = []
    for elem in lista_de_listas_de_puntos:
        lista_puntos_reflejados = calcular_reflejo_punto_eje_x(elem)
...
def escalar_poligono_con_respecto_a_eje_x(lista_de_lista_de_puntos):
    global xmin, ymin, xmax, ymax
    inc_x = int(xmax/10 + xmin)
    inc_y = int(ymax/2 + ymin)
...
def graficar_reflejo_de_triangulo_en_x(lista_puntos_triangulo):
    # Graficar ejes x e y
    graficar_ejes_escalados()
    lista_puntos_reflejados_en_x = calcular_reflejo_poligono_eje_x(lista_puntos_triangulo)
    escalar_poligono_con_respecto_a_eje_x(lista_puntos_triangulo)
    graficar_poligono(lista_puntos_triangulo)
    escalar_poligono_con_respecto_a_eje_x(lista_puntos_reflejados_en_x)
    graficar_poligono(lista_puntos_reflejados_en_x)

def display():
    #lista_puntos_triangulo = [[120.0, 160.0], [100.0, 200.0], [10.0, 100.0]]
    lista_puntos_triangulo = generar_poligono_aleatorio(3)
    glClear(GL_COLOR_BUFFER_BIT)
    graficar_reflejo_de_triangulo_en_x(lista_puntos_triangulo)
    glFlush()

...
def deformar_rectangulo_eje_y():
    ...
    # Deformar
    lista_listas_parametros_rectangulo_deformado = calcular_deformacion_poligono(lista_listas_parametros_rectangulo, [0,2])
    # Mostrar final
...
def main():
    ...
    glutCreateWindow("Deformacion con respecto al eje y")
